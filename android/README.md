...
الوجبات بالصورة عبر Claude API، متابعة يومية، تتبّع صيام، دليل للنظام، سجل ورسوم
...
- مفتاح **Anthropic Claude API** (يُدخل داخل التطبيق ويُخزَّن مشفّراً)، أو الاعتماد
  على وسيط (proxy) كما هو مضبوط في `AppConfig`.
